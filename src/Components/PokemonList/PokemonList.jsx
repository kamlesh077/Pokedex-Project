// Important file to learn useEffect and fetch data by using axios
...
function PokemonList() {
    ...
    async function downloadPokemon() {
            setIsLoading(true); //jaise hi download pokemon call hoga to set is loading true hona chahiye
